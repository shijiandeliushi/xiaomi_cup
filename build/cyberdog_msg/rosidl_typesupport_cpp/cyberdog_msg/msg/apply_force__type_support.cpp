...
static const _ApplyForce_type_support_symbol_names_t _ApplyForce_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cyberdog_msg, msg, ApplyForce)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cyberdog_msg, msg, ApplyForce)),
  }
};
...
{
  return &::cyberdog_msg::msg::rosidl_typesupport_cpp::ApplyForce_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cyberdog_msg, msg, ApplyForce)() {
  return get_message_type_support_handle<cyberdog_msg::msg::ApplyForce>();
}
