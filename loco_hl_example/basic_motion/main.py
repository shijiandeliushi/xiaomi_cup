...
from threading import Thread, Lock
 ...
 #从两个文件中导入消息类
from robot_control_cmd_lcmt import robot_control_cmd_lcmt     #机器人控制命令消息类，包含了发送给MR813的控制指令的结构定义           
from robot_control_response_lcmt import robot_control_response_lcmt   #机器人控制响应消息类，包含了MR813发送回来的状态信息的结构定义
