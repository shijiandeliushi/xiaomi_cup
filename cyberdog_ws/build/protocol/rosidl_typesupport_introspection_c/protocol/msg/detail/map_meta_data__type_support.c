...
#include <stddef.h>
#include "protocol/msg/detail/map_meta_data__rosidl_typesupport_introspection_c.h"
...
void MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  protocol__msg__MapMetaData__init(message_memory);
}

void MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_fini_function(void * message_memory)
{
  protocol__msg__MapMetaData__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_member_array[5] = {
  {
    ...
    offsetof(protocol__msg__MapMetaData, map_load_time),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__MapMetaData, resolution),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__MapMetaData, width),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__MapMetaData, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__MapMetaData, origin),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_members = {
  ...
  5,  // number of fields
  sizeof(protocol__msg__MapMetaData),
  MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_message_member_array,  // message members
  MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_init_function,  // function to initialize message memory (memory has to be allocated)
  MapMetaData__rosidl_typesupport_introspection_c__MapMetaData_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, msg, MapMetaData)() {
