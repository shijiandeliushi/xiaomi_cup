  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  protocol__msg__Keypoint__init(message_memory);
}

void Keypoint__rosidl_typesupport_introspection_c__Keypoint_fini_function(void * message_memory)
{
  protocol__msg__Keypoint__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Keypoint__rosidl_typesupport_introspection_c__Keypoint_message_member_array[2] = {
  {
    "x",  // name
    ...
    offsetof(protocol__msg__Keypoint, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__Keypoint, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Keypoint__rosidl_typesupport_introspection_c__Keypoint_message_members = {
  ...
  2,  // number of fields
  sizeof(protocol__msg__Keypoint),
