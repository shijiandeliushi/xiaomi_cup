...
static rosidl_typesupport_introspection_c__MessageMember CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_member_array[3] = {
  {
    ...
    offsetof(protocol__msg__CompressedImage, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__CompressedImage, format),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol__msg__CompressedImage, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CompressedImage__rosidl_typesupport_introspection_c__CompressedImage_message_members = {
  ...
  3,  // number of fields
  sizeof(protocol__msg__CompressedImage),
