...
static const _AlgoTaskStatus_Request_type_support_symbol_names_t _AlgoTaskStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, srv, AlgoTaskStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, srv, AlgoTaskStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, protocol, srv, AlgoTaskStatus_Request)() {
  return &::protocol::srv::rosidl_typesupport_c::AlgoTaskStatus_Request_message_type_support_handle;
}
...
static const _AlgoTaskStatus_Response_type_support_symbol_names_t _AlgoTaskStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, srv, AlgoTaskStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, srv, AlgoTaskStatus_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_protocol
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, protocol, srv, AlgoTaskStatus_Response)() {
  return &::protocol::srv::rosidl_typesupport_c::AlgoTaskStatus_Response_message_type_support_handle;
}
...
static const _AlgoTaskStatus_type_support_symbol_names_t _AlgoTaskStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, srv, AlgoTaskStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, srv, AlgoTaskStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, protocol, srv, AlgoTaskStatus)() {
  return &::protocol::srv::rosidl_typesupport_c::AlgoTaskStatus_service_type_support_handle;
}
