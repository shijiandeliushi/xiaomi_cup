...
static const _MotionQueueCustomCmd_Request_type_support_symbol_names_t _MotionQueueCustomCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, srv, MotionQueueCustomCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, srv, MotionQueueCustomCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, protocol, srv, MotionQueueCustomCmd_Request)() {
  return &::protocol::srv::rosidl_typesupport_c::MotionQueueCustomCmd_Request_message_type_support_handle;
}
...
static const _MotionQueueCustomCmd_Response_type_support_symbol_names_t _MotionQueueCustomCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, srv, MotionQueueCustomCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, srv, MotionQueueCustomCmd_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_protocol
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, protocol, srv, MotionQueueCustomCmd_Response)() {
  return &::protocol::srv::rosidl_typesupport_c::MotionQueueCustomCmd_Response_message_type_support_handle;
}
...
static const _MotionQueueCustomCmd_type_support_symbol_names_t _MotionQueueCustomCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, srv, MotionQueueCustomCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, protocol, srv, MotionQueueCustomCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, protocol, srv, MotionQueueCustomCmd)() {
  return &::protocol::srv::rosidl_typesupport_c::MotionQueueCustomCmd_service_type_support_handle;
}
