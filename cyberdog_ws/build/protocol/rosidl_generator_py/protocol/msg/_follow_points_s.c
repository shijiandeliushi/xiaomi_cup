...
bool protocol__msg__follow_points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._follow_points.FollowPoints", full_classname_dest, 40) == 0);
  }
  protocol__msg__FollowPoints * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__follow_points__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FollowPoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._follow_points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FollowPoints");
  ...
  protocol__msg__FollowPoints * ros_message = (protocol__msg__FollowPoints *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
