...
bool protocol__msg__compressed_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._compressed_image.CompressedImage", full_classname_dest, 46) == 0);
  }
  protocol__msg__CompressedImage * ros_message = _ros_message;
  {  // header
...
PyObject * protocol__msg__compressed_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._compressed_image");
  ...
  protocol__msg__CompressedImage * ros_message = (protocol__msg__CompressedImage *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
