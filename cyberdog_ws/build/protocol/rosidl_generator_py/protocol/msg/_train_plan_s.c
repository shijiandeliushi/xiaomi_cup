...
bool protocol__msg__train_plan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._train_plan.TrainPlan", full_classname_dest, 34) == 0);
  }
  protocol__msg__TrainPlan * ros_message = _ros_message;
  {  // trigger
...
{
  /* NOTE(esteve): Call constructor of TrainPlan */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._train_plan");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrainPlan");
  ...
  protocol__msg__TrainPlan * ros_message = (protocol__msg__TrainPlan *)raw_ros_message;
  {  // trigger
    PyObject * field = NULL;
