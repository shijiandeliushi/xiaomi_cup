...
bool protocol__msg__self_check_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._self_check_status.SelfCheckStatus", full_classname_dest, 47) == 0);
  }
  protocol__msg__SelfCheckStatus * ros_message = _ros_message;
  {  // code
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__self_check_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of SelfCheckStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._self_check_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SelfCheckStatus");
  ...
  protocol__msg__SelfCheckStatus * ros_message = (protocol__msg__SelfCheckStatus *)raw_ros_message;
  {  // code
    PyObject * field = NULL;
