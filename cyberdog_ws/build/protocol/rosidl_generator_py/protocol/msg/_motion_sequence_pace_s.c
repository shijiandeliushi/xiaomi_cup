...
bool protocol__msg__motion_sequence_pace__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._motion_sequence_pace.MotionSequencePace", full_classname_dest, 53) == 0);
  }
  protocol__msg__MotionSequencePace * ros_message = _ros_message;
  {  // twist
  ...
  {  // centroid
    ...
    if (!geometry_msgs__msg__pose__convert_from_py(field, &ros_message->centroid)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // weight
    ...
    if (!geometry_msgs__msg__twist__convert_from_py(field, &ros_message->weight)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // right_forefoot
    ...
    if (!geometry_msgs__msg__quaternion__convert_from_py(field, &ros_message->right_forefoot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // left_forefoot
    ...
    if (!geometry_msgs__msg__quaternion__convert_from_py(field, &ros_message->left_forefoot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // right_hindfoot
    ...
    if (!geometry_msgs__msg__quaternion__convert_from_py(field, &ros_message->right_hindfoot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // left_hindfoot
    ...
    if (!geometry_msgs__msg__quaternion__convert_from_py(field, &ros_message->left_hindfoot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // landing_gain
    PyObject * field = PyObject_GetAttrString(_pymsg, "landing_gain");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->landing_gain = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // use_mpc_track
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_mpc_track");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_mpc_track = (Py_True == field);
    Py_DECREF(field);
  }
  {  // duration
...
{
  /* NOTE(esteve): Call constructor of MotionSequencePace */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._motion_sequence_pace");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotionSequencePace");
  ...
  protocol__msg__MotionSequencePace * ros_message = (protocol__msg__MotionSequencePace *)raw_ros_message;
  {  // twist
    PyObject * field = NULL;
  ...
  {  // centroid
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose__convert_to_py(&ros_message->centroid);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // weight
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist__convert_to_py(&ros_message->weight);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // right_forefoot
    PyObject * field = NULL;
    field = geometry_msgs__msg__quaternion__convert_to_py(&ros_message->right_forefoot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // left_forefoot
    PyObject * field = NULL;
    field = geometry_msgs__msg__quaternion__convert_to_py(&ros_message->left_forefoot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // right_hindfoot
    PyObject * field = NULL;
    field = geometry_msgs__msg__quaternion__convert_to_py(&ros_message->right_hindfoot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // left_hindfoot
    PyObject * field = NULL;
    field = geometry_msgs__msg__quaternion__convert_to_py(&ros_message->left_hindfoot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // landing_gain
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->landing_gain);
    {
      int rc = PyObject_SetAttrString(_pymessage, "landing_gain", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // use_mpc_track
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_mpc_track ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_mpc_track", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
