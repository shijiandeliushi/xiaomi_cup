...
bool protocol__msg__map_meta_data__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * protocol__msg__map_meta_data__convert_to_py(void * raw_ros_message);
...
bool protocol__msg__occupancy_grid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._occupancy_grid.OccupancyGrid", full_classname_dest, 42) == 0);
  }
  protocol__msg__OccupancyGrid * ros_message = _ros_message;
  {  // header
  ...
  {  // info
    ...
    if (!protocol__msg__map_meta_data__convert_from_py(field, &ros_message->info)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * protocol__msg__occupancy_grid__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._occupancy_grid");
  ...
  protocol__msg__OccupancyGrid * ros_message = (protocol__msg__OccupancyGrid *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // info
    PyObject * field = NULL;
    field = protocol__msg__map_meta_data__convert_to_py(&ros_message->info);
    if (!field) {
      return NULL;
    }
    {
