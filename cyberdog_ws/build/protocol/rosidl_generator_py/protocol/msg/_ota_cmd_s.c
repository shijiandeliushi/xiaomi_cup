...
bool protocol__msg__ota_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._ota_cmd.OtaCmd", full_classname_dest, 28) == 0);
  }
  protocol__msg__OtaCmd * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of OtaCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._ota_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OtaCmd");
  ...
  protocol__msg__OtaCmd * ros_message = (protocol__msg__OtaCmd *)raw_ros_message;
  {  // key
    PyObject * field = NULL;
