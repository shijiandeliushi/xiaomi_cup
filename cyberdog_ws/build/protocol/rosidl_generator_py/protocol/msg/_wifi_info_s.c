...
bool protocol__msg__wifi_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._wifi_info.WifiInfo", full_classname_dest, 32) == 0);
  }
  protocol__msg__WifiInfo * ros_message = _ros_message;
  {  // ssid
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__wifi_info__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of WifiInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._wifi_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WifiInfo");
  ...
  protocol__msg__WifiInfo * ros_message = (protocol__msg__WifiInfo *)raw_ros_message;
  {  // ssid
    PyObject * field = NULL;
