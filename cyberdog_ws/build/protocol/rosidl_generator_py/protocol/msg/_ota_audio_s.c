...
bool protocol__msg__ota_audio__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._ota_audio.OtaAudio", full_classname_dest, 32) == 0);
  }
  protocol__msg__OtaAudio * ros_message = _ros_message;
  {  // command
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__ota_audio__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of OtaAudio */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._ota_audio");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OtaAudio");
  ...
  protocol__msg__OtaAudio * ros_message = (protocol__msg__OtaAudio *)raw_ros_message;
  {  // command
    PyObject * field = NULL;
