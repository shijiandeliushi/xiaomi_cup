...
class Metaclass_MotionServoResponse(type):
    """Metaclass of message 'MotionServoResponse'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__motion_servo_response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__motion_servo_response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__motion_servo_response
            cls._TYPE_SUPPORT = module.type_support_msg__msg__motion_servo_response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__motion_servo_response
...
class MotionServoResponse(metaclass=Metaclass_MotionServoResponse):
    """Message class 'MotionServoResponse'."""
    ...
    def cmd_id(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'cmd_id' field must be an integer in [-2147483648, 2147483647]"
        self._cmd_id = value
