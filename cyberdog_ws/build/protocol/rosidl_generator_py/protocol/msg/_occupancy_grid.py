...
class Metaclass_OccupancyGrid(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__occupancy_grid
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__occupancy_grid
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__occupancy_grid
            cls._TYPE_SUPPORT = module.type_support_msg__msg__occupancy_grid
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__occupancy_grid

            from protocol.msg import MapMetaData
...
class OccupancyGrid(metaclass=Metaclass_OccupancyGrid):
    ...
    _fields_and_field_types = {
        ...
        'info': 'protocol/MapMetaData',
        'data': 'sequence<int8>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['protocol', 'msg'], 'MapMetaData'),  # noqa: E501
