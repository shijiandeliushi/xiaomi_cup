...
bool protocol__srv__bes_http__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._bes_http.BesHttp_Request", full_classname_dest, 38) == 0);
  }
  protocol__srv__BesHttp_Request * ros_message = _ros_message;
  {  // method
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__bes_http__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BesHttp_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._bes_http");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BesHttp_Request");
  ...
  protocol__srv__BesHttp_Request * ros_message = (protocol__srv__BesHttp_Request *)raw_ros_message;
  {  // method
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool protocol__srv__bes_http__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._bes_http.BesHttp_Response", full_classname_dest, 39) == 0);
  }
  protocol__srv__BesHttp_Response * ros_message = _ros_message;
  {  // data
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__bes_http__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BesHttp_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._bes_http");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BesHttp_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  protocol__srv__BesHttp_Response * ros_message = (protocol__srv__BesHttp_Response *)raw_ros_message;
  {  // data
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
