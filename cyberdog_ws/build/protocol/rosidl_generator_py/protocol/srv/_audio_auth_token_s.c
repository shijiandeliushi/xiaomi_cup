...
bool protocol__srv__audio_auth_token__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._audio_auth_token.AudioAuthToken_Request", full_classname_dest, 53) == 0);
  }
  protocol__srv__AudioAuthToken_Request * ros_message = _ros_message;
  {  // uid
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__audio_auth_token__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of AudioAuthToken_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._audio_auth_token");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioAuthToken_Request");
  ...
  protocol__srv__AudioAuthToken_Request * ros_message = (protocol__srv__AudioAuthToken_Request *)raw_ros_message;
  {  // uid
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool protocol__srv__audio_auth_token__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._audio_auth_token.AudioAuthToken_Response", full_classname_dest, 54) == 0);
  }
  protocol__srv__AudioAuthToken_Response * ros_message = _ros_message;
  {  // result
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__audio_auth_token__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of AudioAuthToken_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._audio_auth_token");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioAuthToken_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  protocol__srv__AudioAuthToken_Response * ros_message = (protocol__srv__AudioAuthToken_Response *)raw_ros_message;
  {  // result
    PyObject * field = NULL;
