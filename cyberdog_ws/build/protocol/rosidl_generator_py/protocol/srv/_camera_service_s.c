...
bool protocol__srv__camera_service__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._camera_service.CameraService_Request", full_classname_dest, 50) == 0);
  }
  protocol__srv__CameraService_Request * ros_message = _ros_message;
  {  // command
  ...
  {  // fps
    ...
    assert(PyLong_Check(field));
    ros_message->fps = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__camera_service__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CameraService_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._camera_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraService_Request");
  ...
  protocol__srv__CameraService_Request * ros_message = (protocol__srv__CameraService_Request *)raw_ros_message;
  {  // command
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool protocol__srv__camera_service__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._camera_service.CameraService_Response", full_classname_dest, 51) == 0);
  }
  protocol__srv__CameraService_Response * ros_message = _ros_message;
  {  // result
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__camera_service__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CameraService_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._camera_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraService_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  protocol__srv__CameraService_Response * ros_message = (protocol__srv__CameraService_Response *)raw_ros_message;
  {  // result
    PyObject * field = NULL;
