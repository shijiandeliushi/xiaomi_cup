...
set(_exported_dependencies "builtin_interfaces;sensor_msgs;geometry_msgs;action_msgs;builtin_interfaces;sensor_msgs;geometry_msgs;std_msgs;action_msgs;unique_identifier_msgs;rosidl_runtime_c;rosidl_typesupport_interface;builtin_interfaces;sensor_msgs;geometry_msgs;std_msgs;action_msgs;unique_identifier_msgs;builtin_interfaces;sensor_msgs;geometry_msgs;std_msgs;action_msgs;unique_identifier_msgs;rosidl_default_runtime;builtin_interfaces;sensor_msgs;geometry_msgs;std_msgs")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to protocol_DEFINITIONS, protocol_INCLUDE_DIRS,
# protocol_LIBRARIES, and protocol_LINK_FLAGS.
# Additionally collect the direct dependency names in
# protocol_DEPENDENCIES as well as the recursive dependency names
# in protocol_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(protocol_DEPENDENCIES ${_exported_dependencies})
  set(protocol_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(protocol_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(protocol_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(protocol_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(protocol_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(protocol_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND protocol_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
