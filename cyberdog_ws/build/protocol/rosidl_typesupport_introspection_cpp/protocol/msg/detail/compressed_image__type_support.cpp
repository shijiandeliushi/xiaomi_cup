...
{
  new (message_memory) protocol::msg::CompressedImage(_init);
}

void CompressedImage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::msg::CompressedImage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CompressedImage_message_member_array[3] = {
  {
    ...
    offsetof(protocol::msg::CompressedImage, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::CompressedImage, format),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::CompressedImage, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CompressedImage_message_members = {
  ...
  3,  // number of fields
  sizeof(protocol::msg::CompressedImage),
...
{
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::CompressedImage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, msg, CompressedImage)() {
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::CompressedImage_message_type_support_handle;
}
