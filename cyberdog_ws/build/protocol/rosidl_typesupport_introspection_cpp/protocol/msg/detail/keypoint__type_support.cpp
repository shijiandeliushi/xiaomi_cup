...
{
  new (message_memory) protocol::msg::Keypoint(_init);
}

void Keypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::msg::Keypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Keypoint_message_member_array[2] = {
  {
    ...
    offsetof(protocol::msg::Keypoint, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::Keypoint, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::Keypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, msg, Keypoint)() {
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::Keypoint_message_type_support_handle;
}
