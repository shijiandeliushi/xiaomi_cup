...
#ifndef PROTOCOL__SRV__DETAIL__FACE_REC__FUNCTIONS_H_
#define PROTOCOL__SRV__DETAIL__FACE_REC__FUNCTIONS_H_
...
/// Initialize srv/FaceRec message.
/**
...
/// Create srv/FaceRec message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * protocol__srv__FaceRec_Request__init().
...
/// Destroy srv/FaceRec message.
/**
 * It calls
 * protocol__srv__FaceRec_Request__fini()
...
/// Check for srv/FaceRec message equality.
/**
...
/// Initialize array of srv/FaceRec messages.
/**
...
/// Finalize array of srv/FaceRec messages.
/**
 * It calls
 * protocol__srv__FaceRec_Request__fini()
...
/// Create array of srv/FaceRec messages.
/**
 * It allocates the memory for the array and calls
 * protocol__srv__FaceRec_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FaceRec messages.
/**
 * It calls
 * protocol__srv__FaceRec_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FaceRec message array equality.
/**
...
/// Copy an array of srv/FaceRec messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * protocol__srv__FaceRec_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It calls
 * protocol__srv__FaceRec_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It allocates the memory for the array and calls
 * protocol__srv__FaceRec_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It calls
 * protocol__srv__FaceRec_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PROTOCOL__SRV__DETAIL__FACE_REC__FUNCTIONS_H_
