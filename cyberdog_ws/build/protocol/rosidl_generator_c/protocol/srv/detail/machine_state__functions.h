...
#ifndef PROTOCOL__SRV__DETAIL__MACHINE_STATE__FUNCTIONS_H_
#define PROTOCOL__SRV__DETAIL__MACHINE_STATE__FUNCTIONS_H_
...
/// Initialize srv/MachineState message.
/**
...
/// Finalize srv/MachineState message.
/**
...
/// Create srv/MachineState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * protocol__srv__MachineState_Request__init().
...
/// Destroy srv/MachineState message.
/**
 * It calls
 * protocol__srv__MachineState_Request__fini()
...
/// Check for srv/MachineState message equality.
/**
...
/// Copy a srv/MachineState message.
/**
...
/// Initialize array of srv/MachineState messages.
/**
...
/// Finalize array of srv/MachineState messages.
/**
 * It calls
 * protocol__srv__MachineState_Request__fini()
...
/// Create array of srv/MachineState messages.
/**
 * It allocates the memory for the array and calls
 * protocol__srv__MachineState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MachineState messages.
/**
 * It calls
 * protocol__srv__MachineState_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MachineState message array equality.
/**
...
/// Copy an array of srv/MachineState messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * protocol__srv__MachineState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It calls
 * protocol__srv__MachineState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It allocates the memory for the array and calls
 * protocol__srv__MachineState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It calls
 * protocol__srv__MachineState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PROTOCOL__SRV__DETAIL__MACHINE_STATE__FUNCTIONS_H_
