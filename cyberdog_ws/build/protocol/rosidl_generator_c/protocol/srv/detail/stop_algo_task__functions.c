...
protocol__srv__StopAlgoTask_Request__init(protocol__srv__StopAlgoTask_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->map_name)) {
    protocol__srv__StopAlgoTask_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  protocol__srv__StopAlgoTask_Request * msg = (protocol__srv__StopAlgoTask_Request *)malloc(sizeof(protocol__srv__StopAlgoTask_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(protocol__srv__StopAlgoTask_Request));
  bool success = protocol__srv__StopAlgoTask_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
protocol__srv__StopAlgoTask_Request__Sequence__init(protocol__srv__StopAlgoTask_Request__Sequence * array, size_t size)
{
  ...
  protocol__srv__StopAlgoTask_Request * data = NULL;
  if (size) {
    data = (protocol__srv__StopAlgoTask_Request *)calloc(size, sizeof(protocol__srv__StopAlgoTask_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = protocol__srv__StopAlgoTask_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        protocol__srv__StopAlgoTask_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
protocol__srv__StopAlgoTask_Request__Sequence__fini(protocol__srv__StopAlgoTask_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      protocol__srv__StopAlgoTask_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  protocol__srv__StopAlgoTask_Request__Sequence * array = (protocol__srv__StopAlgoTask_Request__Sequence *)malloc(sizeof(protocol__srv__StopAlgoTask_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = protocol__srv__StopAlgoTask_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    protocol__srv__StopAlgoTask_Request__Sequence__fini(array);
  }
  free(array);
}
...
protocol__srv__StopAlgoTask_Request__Sequence__are_equal(const protocol__srv__StopAlgoTask_Request__Sequence * lhs, const protocol__srv__StopAlgoTask_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!protocol__srv__StopAlgoTask_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  protocol__srv__StopAlgoTask_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(protocol__srv__StopAlgoTask_Request);
    protocol__srv__StopAlgoTask_Request * data =
      (protocol__srv__StopAlgoTask_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!protocol__srv__StopAlgoTask_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          protocol__srv__StopAlgoTask_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!protocol__srv__StopAlgoTask_Request__copy(
...
{
  protocol__srv__StopAlgoTask_Response * msg = (protocol__srv__StopAlgoTask_Response *)malloc(sizeof(protocol__srv__StopAlgoTask_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(protocol__srv__StopAlgoTask_Response));
  bool success = protocol__srv__StopAlgoTask_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    protocol__srv__StopAlgoTask_Response__fini(msg);
  }
  free(msg);
}
...
protocol__srv__StopAlgoTask_Response__Sequence__init(protocol__srv__StopAlgoTask_Response__Sequence * array, size_t size)
{
  ...
  protocol__srv__StopAlgoTask_Response * data = NULL;
  if (size) {
    data = (protocol__srv__StopAlgoTask_Response *)calloc(size, sizeof(protocol__srv__StopAlgoTask_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = protocol__srv__StopAlgoTask_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        protocol__srv__StopAlgoTask_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
protocol__srv__StopAlgoTask_Response__Sequence__fini(protocol__srv__StopAlgoTask_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      protocol__srv__StopAlgoTask_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  protocol__srv__StopAlgoTask_Response__Sequence * array = (protocol__srv__StopAlgoTask_Response__Sequence *)malloc(sizeof(protocol__srv__StopAlgoTask_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = protocol__srv__StopAlgoTask_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    protocol__srv__StopAlgoTask_Response__Sequence__fini(array);
  }
  free(array);
}
...
protocol__srv__StopAlgoTask_Response__Sequence__are_equal(const protocol__srv__StopAlgoTask_Response__Sequence * lhs, const protocol__srv__StopAlgoTask_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!protocol__srv__StopAlgoTask_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  protocol__srv__StopAlgoTask_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(protocol__srv__StopAlgoTask_Response);
    protocol__srv__StopAlgoTask_Response * data =
      (protocol__srv__StopAlgoTask_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!protocol__srv__StopAlgoTask_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          protocol__srv__StopAlgoTask_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!protocol__srv__StopAlgoTask_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
