...
#ifndef PROTOCOL__SRV__DETAIL__REBOOT_MACHINE__FUNCTIONS_H_
#define PROTOCOL__SRV__DETAIL__REBOOT_MACHINE__FUNCTIONS_H_
...
/// Initialize srv/RebootMachine message.
/**
...
/// Finalize srv/RebootMachine message.
/**
...
/// Create srv/RebootMachine message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * protocol__srv__RebootMachine_Request__init().
...
/// Destroy srv/RebootMachine message.
/**
 * It calls
 * protocol__srv__RebootMachine_Request__fini()
...
/// Check for srv/RebootMachine message equality.
/**
...
/// Copy a srv/RebootMachine message.
/**
...
/// Initialize array of srv/RebootMachine messages.
/**
...
/// Finalize array of srv/RebootMachine messages.
/**
 * It calls
 * protocol__srv__RebootMachine_Request__fini()
...
/// Create array of srv/RebootMachine messages.
/**
 * It allocates the memory for the array and calls
 * protocol__srv__RebootMachine_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RebootMachine messages.
/**
 * It calls
 * protocol__srv__RebootMachine_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RebootMachine message array equality.
/**
...
/// Copy an array of srv/RebootMachine messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * protocol__srv__RebootMachine_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It calls
 * protocol__srv__RebootMachine_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It allocates the memory for the array and calls
 * protocol__srv__RebootMachine_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_protocol
...
/**
 * It calls
 * protocol__srv__RebootMachine_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PROTOCOL__SRV__DETAIL__REBOOT_MACHINE__FUNCTIONS_H_
