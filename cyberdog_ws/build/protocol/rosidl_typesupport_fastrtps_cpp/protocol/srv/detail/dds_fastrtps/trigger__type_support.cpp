...
#include "protocol/srv/detail/trigger__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::srv::Trigger_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::srv::Trigger_Request & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const protocol::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  return &protocol::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, Trigger_Request)() {
  return &protocol::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_protocol
cdr_serialize(
  const protocol::srv::Trigger_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::srv::Trigger_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const protocol::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<protocol::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &protocol::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, Trigger_Response)() {
  return &protocol::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
{
  return &protocol::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, Trigger)() {
  return &protocol::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
