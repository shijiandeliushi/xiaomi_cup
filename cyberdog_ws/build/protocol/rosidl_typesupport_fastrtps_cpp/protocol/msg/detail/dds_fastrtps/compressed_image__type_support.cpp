...
#include "protocol/msg/detail/compressed_image__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::CompressedImage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::CompressedImage & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const protocol::msg::CompressedImage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::CompressedImage *>(
    untyped_ros_message);
...
static size_t _CompressedImage__max_serialized_size(bool & full_bounded)
{
...
{
  return &protocol::msg::typesupport_fastrtps_cpp::_CompressedImage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, CompressedImage)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_CompressedImage__handle;
}
