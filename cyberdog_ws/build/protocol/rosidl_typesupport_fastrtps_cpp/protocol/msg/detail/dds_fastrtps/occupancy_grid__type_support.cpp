...
#include "protocol/msg/detail/occupancy_grid__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const protocol::msg::MapMetaData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  protocol::msg::MapMetaData &);
size_t get_serialized_size(
  const protocol::msg::MapMetaData &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const protocol::msg::OccupancyGrid & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::OccupancyGrid & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        protocol::msg::typesupport_fastrtps_cpp::max_serialized_size_MapMetaData(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const protocol::msg::OccupancyGrid *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::OccupancyGrid *>(
    untyped_ros_message);
...
{
  return max_serialized_size_OccupancyGrid(full_bounded, 0);
}
...
{
  return &protocol::msg::typesupport_fastrtps_cpp::_OccupancyGrid__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, OccupancyGrid)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_OccupancyGrid__handle;
}
