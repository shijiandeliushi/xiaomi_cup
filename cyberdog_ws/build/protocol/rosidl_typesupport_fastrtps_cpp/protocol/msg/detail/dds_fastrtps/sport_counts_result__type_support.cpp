...
#include "protocol/msg/detail/sport_counts_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::SportCountsResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::SportCountsResult & ros_message)
{
  // Member: algo_switch
  cdr >> ros_message.algo_switch;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_protocol
max_serialized_size_SportCountsResult(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const protocol::msg::SportCountsResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::SportCountsResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SportCountsResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const protocol::msg::SportCountsResult *>(
...
{
  return max_serialized_size_SportCountsResult(full_bounded, 0);
}

static message_type_support_callbacks_t _SportCountsResult__callbacks = {
  "protocol::msg",
  "SportCountsResult",
...
static rosidl_message_type_support_t _SportCountsResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SportCountsResult__callbacks,
...
{
  return &protocol::msg::typesupport_fastrtps_cpp::_SportCountsResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, SportCountsResult)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_SportCountsResult__handle;
}
