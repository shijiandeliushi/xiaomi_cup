...
#include "protocol/msg/detail/face__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::Face & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.row;
  // Member: is_host
  cdr << (ros_message.is_host ? true : false);
  // Member: age
  cdr << ros_message.age;
  // Member: emotion
  ...
  protocol::msg::Face & ros_message)
{
  ...
  // Member: is_host
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.is_host = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: match
  {
    size_t item_size = sizeof(ros_message.match);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: yaw
  ...
  // Member: is_host
  {
    size_t item_size = sizeof(ros_message.is_host);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: age
...
{
  auto typed_message =
    static_cast<const protocol::msg::Face *>(
    untyped_ros_message);
...
static size_t _Face__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Face(full_bounded, 0);
}
...
get_message_type_support_handle<protocol::msg::Face>()
{
  return &protocol::msg::typesupport_fastrtps_cpp::_Face__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, Face)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_Face__handle;
}
