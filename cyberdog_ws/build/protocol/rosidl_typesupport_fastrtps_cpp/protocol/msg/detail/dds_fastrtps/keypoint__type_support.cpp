...
#include "protocol/msg/detail/keypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::Keypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::Keypoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const protocol::msg::Keypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::Keypoint *>(
    untyped_ros_message);
...
{
  return &protocol::msg::typesupport_fastrtps_cpp::_Keypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, Keypoint)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_Keypoint__handle;
}
