...
#include "protocol/msg/detail/gps_payload__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::GpsPayload & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::GpsPayload & ros_message)
{
  // Member: sec
  cdr >> ros_message.sec;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_protocol
max_serialized_size_GpsPayload(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const protocol::msg::GpsPayload *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::GpsPayload *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GpsPayload__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const protocol::msg::GpsPayload *>(
...
{
  return max_serialized_size_GpsPayload(full_bounded, 0);
}

static message_type_support_callbacks_t _GpsPayload__callbacks = {
  "protocol::msg",
  "GpsPayload",
...
static rosidl_message_type_support_t _GpsPayload__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GpsPayload__callbacks,
...
get_message_type_support_handle<protocol::msg::GpsPayload>()
{
  return &protocol::msg::typesupport_fastrtps_cpp::_GpsPayload__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, GpsPayload)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_GpsPayload__handle;
}
