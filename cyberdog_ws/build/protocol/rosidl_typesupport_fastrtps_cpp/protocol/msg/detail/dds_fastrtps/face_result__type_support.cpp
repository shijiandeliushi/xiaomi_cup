...
#include "protocol/msg/detail/face_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::FaceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::FaceResult & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_protocol
max_serialized_size_FaceResult(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const protocol::msg::FaceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::FaceResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaceResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const protocol::msg::FaceResult *>(
...
{
  return max_serialized_size_FaceResult(full_bounded, 0);
}

static message_type_support_callbacks_t _FaceResult__callbacks = {
  "protocol::msg",
  "FaceResult",
...
static rosidl_message_type_support_t _FaceResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaceResult__callbacks,
...
{
  return &protocol::msg::typesupport_fastrtps_cpp::_FaceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, FaceResult)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_FaceResult__handle;
}
