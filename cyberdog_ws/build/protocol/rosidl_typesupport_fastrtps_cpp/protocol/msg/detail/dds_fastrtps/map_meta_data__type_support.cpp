...
#include "protocol/msg/detail/map_meta_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const protocol::msg::MapMetaData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  protocol::msg::MapMetaData & ros_message)
{
  // Member: map_load_time
...
{
  auto typed_message =
    static_cast<const protocol::msg::MapMetaData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<protocol::msg::MapMetaData *>(
    untyped_ros_message);
...
{
  return &protocol::msg::typesupport_fastrtps_cpp::_MapMetaData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, MapMetaData)() {
  return &protocol::msg::typesupport_fastrtps_cpp::_MapMetaData__handle;
}
