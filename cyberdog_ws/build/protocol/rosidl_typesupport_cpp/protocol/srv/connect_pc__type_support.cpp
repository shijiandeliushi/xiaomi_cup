...
static const _ConnectPc_Request_type_support_symbol_names_t _ConnectPc_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, ConnectPc_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, ConnectPc_Request)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::ConnectPc_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, ConnectPc_Request)() {
  return get_message_type_support_handle<protocol::srv::ConnectPc_Request>();
}
...
static const _ConnectPc_Response_type_support_symbol_names_t _ConnectPc_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, ConnectPc_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, ConnectPc_Response)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::ConnectPc_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, ConnectPc_Response)() {
  return get_message_type_support_handle<protocol::srv::ConnectPc_Response>();
}
...
static const _ConnectPc_type_support_symbol_names_t _ConnectPc_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, ConnectPc)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, ConnectPc)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::ConnectPc_service_type_support_handle;
}
