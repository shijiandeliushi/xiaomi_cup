...
static const _DeviceInfo_Request_type_support_symbol_names_t _DeviceInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, DeviceInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, DeviceInfo_Request)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::DeviceInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, DeviceInfo_Request)() {
  return get_message_type_support_handle<protocol::srv::DeviceInfo_Request>();
}
...
static const _DeviceInfo_Response_type_support_symbol_names_t _DeviceInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, DeviceInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, DeviceInfo_Response)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::DeviceInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, DeviceInfo_Response)() {
  return get_message_type_support_handle<protocol::srv::DeviceInfo_Response>();
}
...
static const _DeviceInfo_type_support_symbol_names_t _DeviceInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, DeviceInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, DeviceInfo)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::DeviceInfo_service_type_support_handle;
}
