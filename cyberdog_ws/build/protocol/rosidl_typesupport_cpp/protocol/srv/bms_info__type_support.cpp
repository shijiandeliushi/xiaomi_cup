...
static const _BmsInfo_Request_type_support_symbol_names_t _BmsInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, BmsInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, BmsInfo_Request)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::BmsInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, BmsInfo_Request)() {
  return get_message_type_support_handle<protocol::srv::BmsInfo_Request>();
}
...
static const _BmsInfo_Response_type_support_symbol_names_t _BmsInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, BmsInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, BmsInfo_Response)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::BmsInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, BmsInfo_Response)() {
  return get_message_type_support_handle<protocol::srv::BmsInfo_Response>();
}
...
static const _BmsInfo_type_support_symbol_names_t _BmsInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, BmsInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, BmsInfo)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::BmsInfo_service_type_support_handle;
}
