...
static const _ElecSkin_Request_type_support_symbol_names_t _ElecSkin_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, ElecSkin_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, ElecSkin_Request)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::ElecSkin_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, ElecSkin_Request)() {
  return get_message_type_support_handle<protocol::srv::ElecSkin_Request>();
}
...
static const _ElecSkin_Response_type_support_symbol_names_t _ElecSkin_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, ElecSkin_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, ElecSkin_Response)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::ElecSkin_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, srv, ElecSkin_Response)() {
  return get_message_type_support_handle<protocol::srv::ElecSkin_Response>();
}
...
static const _ElecSkin_type_support_symbol_names_t _ElecSkin_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, srv, ElecSkin)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, ElecSkin)),
  }
};
...
{
  return &::protocol::srv::rosidl_typesupport_cpp::ElecSkin_service_type_support_handle;
}
