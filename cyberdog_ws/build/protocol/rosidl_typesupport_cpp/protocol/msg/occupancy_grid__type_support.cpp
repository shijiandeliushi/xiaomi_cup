...
static const _OccupancyGrid_type_support_symbol_names_t _OccupancyGrid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, protocol, msg, OccupancyGrid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, msg, OccupancyGrid)),
  }
};
...
{
  return &::protocol::msg::rosidl_typesupport_cpp::OccupancyGrid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, protocol, msg, OccupancyGrid)() {
  return get_message_type_support_handle<protocol::msg::OccupancyGrid>();
}
