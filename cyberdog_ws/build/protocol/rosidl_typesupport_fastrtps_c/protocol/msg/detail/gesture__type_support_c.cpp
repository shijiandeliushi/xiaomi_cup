...
#include "protocol/msg/detail/gesture__rosidl_typesupport_fastrtps_c.h"
...
using _Gesture__ros_msg_type = protocol__msg__Gesture;
...
static uint32_t _Gesture__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__Gesture(
...
{
  return max_serialized_size_protocol__msg__Gesture(
    full_bounded, 0);
}
