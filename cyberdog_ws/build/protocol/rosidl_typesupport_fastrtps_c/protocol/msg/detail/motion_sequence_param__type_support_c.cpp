...
#include "protocol/msg/detail/motion_sequence_param__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // centroid_height, left_forefoot, left_hindfoot, right_forefoot, right_hindfoot
...
using _MotionSequenceParam__ros_msg_type = protocol__msg__MotionSequenceParam;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotionSequenceParam__ros_msg_type * ros_message = static_cast<const _MotionSequenceParam__ros_msg_type *>(untyped_ros_message);
  // Field name: twist
  {
  ...
  // Field name: centroid_height
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->centroid_height, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: right_forefoot
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->right_forefoot, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: right_hindfoot
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->right_hindfoot, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: left_hindfoot
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->left_hindfoot, cdr))
    {
      return false;
    }
  }

  // Field name: forefoot_height
  {
    cdr << ros_message->forefoot_height;
  }

  // Field name: hindfoot_height
  {
    cdr << ros_message->hindfoot_height;
  }

  // Field name: friction_coefficient
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MotionSequenceParam__ros_msg_type * ros_message = static_cast<_MotionSequenceParam__ros_msg_type *>(untyped_ros_message);
  // Field name: twist
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _MotionSequenceParam__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__MotionSequenceParam(
...
{
  return max_serialized_size_protocol__msg__MotionSequenceParam(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MotionSequenceParam = {
  "protocol::msg",
  "MotionSequenceParam",
...
static rosidl_message_type_support_t _MotionSequenceParam__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotionSequenceParam,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, msg, MotionSequenceParam)() {
  return &_MotionSequenceParam__type_support;
}
