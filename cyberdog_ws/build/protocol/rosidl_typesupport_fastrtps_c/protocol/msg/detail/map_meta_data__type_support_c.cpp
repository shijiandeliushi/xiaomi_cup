...
#include "protocol/msg/detail/map_meta_data__rosidl_typesupport_fastrtps_c.h"
...
using _MapMetaData__ros_msg_type = protocol__msg__MapMetaData;
...
static uint32_t _MapMetaData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__MapMetaData(
...
{
  return max_serialized_size_protocol__msg__MapMetaData(
    full_bounded, 0);
}
