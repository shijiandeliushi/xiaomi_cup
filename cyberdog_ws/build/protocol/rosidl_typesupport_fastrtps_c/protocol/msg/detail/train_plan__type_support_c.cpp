...
#include "protocol/msg/detail/train_plan__rosidl_typesupport_fastrtps_c.h"
...
using _TrainPlan__ros_msg_type = protocol__msg__TrainPlan;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrainPlan__ros_msg_type * ros_message = static_cast<const _TrainPlan__ros_msg_type *>(untyped_ros_message);
  // Field name: trigger
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrainPlan__ros_msg_type * ros_message = static_cast<_TrainPlan__ros_msg_type *>(untyped_ros_message);
  // Field name: trigger
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _TrainPlan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__TrainPlan(
...
{
  return max_serialized_size_protocol__msg__TrainPlan(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_TrainPlan = {
  "protocol::msg",
  "TrainPlan",
