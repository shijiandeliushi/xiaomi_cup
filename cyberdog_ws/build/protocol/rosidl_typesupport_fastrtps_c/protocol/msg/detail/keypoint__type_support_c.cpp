...
#include "protocol/msg/detail/keypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Keypoint__ros_msg_type = protocol__msg__Keypoint;
...
static uint32_t _Keypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__Keypoint(
...
{
  return max_serialized_size_protocol__msg__Keypoint(
    full_bounded, 0);
}
