...
#include "protocol/msg/detail/occupancy_grid__rosidl_typesupport_fastrtps_c.h"
...
#include "protocol/msg/detail/map_meta_data__functions.h"  // info
#include "rosidl_runtime_c/primitives_sequence.h"  // data
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // data
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_protocol__msg__MapMetaData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_protocol__msg__MapMetaData(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, protocol, msg, MapMetaData)();
...
using _OccupancyGrid__ros_msg_type = protocol__msg__OccupancyGrid;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, protocol, msg, MapMetaData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _OccupancyGrid__ros_msg_type * ros_message = static_cast<_OccupancyGrid__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_protocol__msg__MapMetaData(
...
static uint32_t _OccupancyGrid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__OccupancyGrid(
  ...
  size_t current_alignment)
{
  ...
  // member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_protocol__msg__MapMetaData(
        full_bounded, current_alignment);
    }
  }
  // member: data
...
static size_t _OccupancyGrid__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_protocol__msg__OccupancyGrid(
    full_bounded, 0);
}
