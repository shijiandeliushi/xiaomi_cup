...
#include "protocol/msg/detail/compressed_image__rosidl_typesupport_fastrtps_c.h"
...
using _CompressedImage__ros_msg_type = protocol__msg__CompressedImage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CompressedImage__ros_msg_type * ros_message = static_cast<const _CompressedImage__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CompressedImage__ros_msg_type * ros_message = static_cast<_CompressedImage__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _CompressedImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_protocol__msg__CompressedImage(
...
{
  return max_serialized_size_protocol__msg__CompressedImage(
    full_bounded, 0);
}
