...
{
  new (message_memory) protocol::srv::DeviceInfo_Request(_init);
}

void DeviceInfo_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::srv::DeviceInfo_Request *>(message_memory);
  typed_message->~DeviceInfo_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DeviceInfo_Request_message_member_array[2] = {
  {
    "enables",  // name
    ...
    offsetof(protocol::srv::DeviceInfo_Request, enables),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::srv::DeviceInfo_Request, uid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DeviceInfo_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(protocol::srv::DeviceInfo_Request),
...
{
  return &::protocol::srv::rosidl_typesupport_introspection_cpp::DeviceInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, DeviceInfo_Request)() {
  return &::protocol::srv::rosidl_typesupport_introspection_cpp::DeviceInfo_Request_message_type_support_handle;
}
...
void DeviceInfo_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) protocol::srv::DeviceInfo_Response(_init);
}

void DeviceInfo_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::srv::DeviceInfo_Response *>(message_memory);
  typed_message->~DeviceInfo_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DeviceInfo_Response_message_member_array[2] = {
  {
    "info",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_STRING,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::srv::DeviceInfo_Response, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::srv::DeviceInfo_Response, code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DeviceInfo_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(protocol::srv::DeviceInfo_Response),
...
{
  return &::protocol::srv::rosidl_typesupport_introspection_cpp::DeviceInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, DeviceInfo_Response)() {
  return &::protocol::srv::rosidl_typesupport_introspection_cpp::DeviceInfo_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers DeviceInfo_service_members = {
  ...
  // see get_service_type_support_handle<protocol::srv::DeviceInfo>()
...
get_service_type_support_handle<protocol::srv::DeviceInfo>()
{
  ...
  auto service_type_support =
    &::protocol::srv::rosidl_typesupport_introspection_cpp::DeviceInfo_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, srv, DeviceInfo)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<protocol::srv::DeviceInfo>();
}
