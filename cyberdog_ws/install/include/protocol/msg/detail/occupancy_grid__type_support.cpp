...
{
  new (message_memory) protocol::msg::OccupancyGrid(_init);
}

void OccupancyGrid_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::msg::OccupancyGrid *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OccupancyGrid_message_member_array[3] = {
  {
    ...
    offsetof(protocol::msg::OccupancyGrid, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<protocol::msg::MapMetaData>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::OccupancyGrid, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::OccupancyGrid, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OccupancyGrid_message_members = {
  ...
  3,  // number of fields
  sizeof(protocol::msg::OccupancyGrid),
...
get_message_type_support_handle<protocol::msg::OccupancyGrid>()
{
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::OccupancyGrid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, msg, OccupancyGrid)() {
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::OccupancyGrid_message_type_support_handle;
}
