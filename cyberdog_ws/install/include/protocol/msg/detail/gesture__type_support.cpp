...
{
  new (message_memory) protocol::msg::Gesture(_init);
}

void Gesture_fini_function(void * message_memory)
{
  auto typed_message = static_cast<protocol::msg::Gesture *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Gesture_message_member_array[2] = {
  {
    ...
    offsetof(protocol::msg::Gesture, roi),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(protocol::msg::Gesture, cls),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::Gesture_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, protocol, msg, Gesture)() {
  return &::protocol::msg::rosidl_typesupport_introspection_cpp::Gesture_message_type_support_handle;
}
