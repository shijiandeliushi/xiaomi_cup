...
protocol__msg__AudioVoiceprintResult__init(protocol__msg__AudioVoiceprintResult * msg)
{
  ...
  if (!protocol__msg__VoicePrint__init(&msg->voice_print)) {
    protocol__msg__AudioVoiceprintResult__fini(msg);
    return false;
  }
  return true;
}
...
{
  protocol__msg__AudioVoiceprintResult * msg = (protocol__msg__AudioVoiceprintResult *)malloc(sizeof(protocol__msg__AudioVoiceprintResult));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(protocol__msg__AudioVoiceprintResult));
  bool success = protocol__msg__AudioVoiceprintResult__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
protocol__msg__AudioVoiceprintResult__Sequence__init(protocol__msg__AudioVoiceprintResult__Sequence * array, size_t size)
{
  ...
  protocol__msg__AudioVoiceprintResult * data = NULL;
  if (size) {
    data = (protocol__msg__AudioVoiceprintResult *)calloc(size, sizeof(protocol__msg__AudioVoiceprintResult));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = protocol__msg__AudioVoiceprintResult__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        protocol__msg__AudioVoiceprintResult__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
protocol__msg__AudioVoiceprintResult__Sequence__fini(protocol__msg__AudioVoiceprintResult__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      protocol__msg__AudioVoiceprintResult__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  protocol__msg__AudioVoiceprintResult__Sequence * array = (protocol__msg__AudioVoiceprintResult__Sequence *)malloc(sizeof(protocol__msg__AudioVoiceprintResult__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = protocol__msg__AudioVoiceprintResult__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    protocol__msg__AudioVoiceprintResult__Sequence__fini(array);
  }
  free(array);
}
...
protocol__msg__AudioVoiceprintResult__Sequence__are_equal(const protocol__msg__AudioVoiceprintResult__Sequence * lhs, const protocol__msg__AudioVoiceprintResult__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!protocol__msg__AudioVoiceprintResult__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  protocol__msg__AudioVoiceprintResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(protocol__msg__AudioVoiceprintResult);
    protocol__msg__AudioVoiceprintResult * data =
      (protocol__msg__AudioVoiceprintResult *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!protocol__msg__AudioVoiceprintResult__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          protocol__msg__AudioVoiceprintResult__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!protocol__msg__AudioVoiceprintResult__copy(
