...
bool protocol__msg__map_meta_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._map_meta_data.MapMetaData", full_classname_dest, 39) == 0);
  }
  protocol__msg__MapMetaData * ros_message = _ros_message;
  {  // map_load_time
...
PyObject * protocol__msg__map_meta_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._map_meta_data");
  ...
  protocol__msg__MapMetaData * ros_message = (protocol__msg__MapMetaData *)raw_ros_message;
  {  // map_load_time
    PyObject * field = NULL;
