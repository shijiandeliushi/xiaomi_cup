...
bool protocol__msg__rear_tof_payload__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._rear_tof_payload.RearTofPayload", full_classname_dest, 45) == 0);
  }
  protocol__msg__RearTofPayload * ros_message = _ros_message;
  {  // left_rear
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__rear_tof_payload__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RearTofPayload */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._rear_tof_payload");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RearTofPayload");
  ...
  protocol__msg__RearTofPayload * ros_message = (protocol__msg__RearTofPayload *)raw_ros_message;
  {  // left_rear
    PyObject * field = NULL;
