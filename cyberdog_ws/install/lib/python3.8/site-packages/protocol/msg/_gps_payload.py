...
class Metaclass_GpsPayload(type):
    """Metaclass of message 'GpsPayload'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'protocol.msg.GpsPayload')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__gps_payload
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__gps_payload
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__gps_payload
            cls._TYPE_SUPPORT = module.type_support_msg__msg__gps_payload
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__gps_payload
...
class GpsPayload(metaclass=Metaclass_GpsPayload):
    """Message class 'GpsPayload'."""
    ...
    def sec(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'sec' field must be an unsigned integer in [0, 4294967295]"
        self._sec = value
