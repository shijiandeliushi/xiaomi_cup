...
bool protocol__msg__track_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._track_result.TrackResult", full_classname_dest, 38) == 0);
  }
  protocol__msg__TrackResult * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TrackResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._track_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackResult");
  ...
  protocol__msg__TrackResult * ros_message = (protocol__msg__TrackResult *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
