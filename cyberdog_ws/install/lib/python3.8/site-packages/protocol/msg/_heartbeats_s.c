...
bool protocol__msg__heartbeats__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._heartbeats.Heartbeats", full_classname_dest, 35) == 0);
  }
  protocol__msg__Heartbeats * ros_message = _ros_message;
  {  // name
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__heartbeats__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Heartbeats */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._heartbeats");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Heartbeats");
  ...
  protocol__msg__Heartbeats * ros_message = (protocol__msg__Heartbeats *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
