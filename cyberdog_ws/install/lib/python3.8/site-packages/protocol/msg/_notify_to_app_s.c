...
bool protocol__msg__notify_to_app__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._notify_to_app.NotifyToApp", full_classname_dest, 39) == 0);
  }
  protocol__msg__NotifyToApp * ros_message = _ros_message;
  {  // ssid
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__notify_to_app__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of NotifyToApp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._notify_to_app");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NotifyToApp");
  ...
  protocol__msg__NotifyToApp * ros_message = (protocol__msg__NotifyToApp *)raw_ros_message;
  {  // ssid
    PyObject * field = NULL;
