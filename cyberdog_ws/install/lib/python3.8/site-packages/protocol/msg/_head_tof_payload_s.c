...
bool protocol__msg__head_tof_payload__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._head_tof_payload.HeadTofPayload", full_classname_dest, 45) == 0);
  }
  protocol__msg__HeadTofPayload * ros_message = _ros_message;
  {  // left_head
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__head_tof_payload__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of HeadTofPayload */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._head_tof_payload");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HeadTofPayload");
  ...
  protocol__msg__HeadTofPayload * ros_message = (protocol__msg__HeadTofPayload *)raw_ros_message;
  {  // left_head
    PyObject * field = NULL;
