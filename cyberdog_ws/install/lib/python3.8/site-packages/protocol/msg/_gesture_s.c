...
bool protocol__msg__gesture__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.msg._gesture.Gesture", full_classname_dest, 29) == 0);
  }
  protocol__msg__Gesture * ros_message = _ros_message;
  {  // roi
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__msg__gesture__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Gesture */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.msg._gesture");
  ...
  protocol__msg__Gesture * ros_message = (protocol__msg__Gesture *)raw_ros_message;
  {  // roi
    PyObject * field = NULL;
