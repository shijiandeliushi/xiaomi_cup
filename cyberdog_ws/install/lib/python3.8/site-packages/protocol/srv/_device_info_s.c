...
bool protocol__srv__device_info__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._device_info.DeviceInfo_Request", full_classname_dest, 44) == 0);
  }
  protocol__srv__DeviceInfo_Request * ros_message = _ros_message;
  {  // enables
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      bool * dest = ros_message->enables.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'enables'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__device_info__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of DeviceInfo_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._device_info");
  ...
  protocol__srv__DeviceInfo_Request * ros_message = (protocol__srv__DeviceInfo_Request *)raw_ros_message;
  {  // enables
    PyObject * field = NULL;
    size_t size = ros_message->enables.size;
    bool * src = ros_message->enables.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "enables", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool protocol__srv__device_info__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._device_info.DeviceInfo_Response", full_classname_dest, 45) == 0);
  }
  protocol__srv__DeviceInfo_Response * ros_message = _ros_message;
  {  // info
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__device_info__response__convert_to_py(void * raw_ros_message)
{
  ...
  protocol__srv__DeviceInfo_Response * ros_message = (protocol__srv__DeviceInfo_Response *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
