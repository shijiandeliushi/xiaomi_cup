...
bool protocol__srv__face_rec__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._face_rec.FaceRec_Request", full_classname_dest, 38) == 0);
  }
  protocol__srv__FaceRec_Request * ros_message = _ros_message;
  {  // command
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__face_rec__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FaceRec_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._face_rec");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FaceRec_Request");
  ...
  protocol__srv__FaceRec_Request * ros_message = (protocol__srv__FaceRec_Request *)raw_ros_message;
  {  // command
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool protocol__srv__face_rec__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("protocol.srv._face_rec.FaceRec_Response", full_classname_dest, 39) == 0);
  }
  protocol__srv__FaceRec_Response * ros_message = _ros_message;
  {  // result
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * protocol__srv__face_rec__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FaceRec_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("protocol.srv._face_rec");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FaceRec_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  protocol__srv__FaceRec_Response * ros_message = (protocol__srv__FaceRec_Response *)raw_ros_message;
  {  // result
    PyObject * field = NULL;
